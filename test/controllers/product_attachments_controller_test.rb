...
class ProductAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_attachment" do
    assert_difference('ProductAttachment.count') do
      post product_attachments_url, params: { product_attachment: { photo: @product_attachment.photo, product_id: @product_attachment.product_id } }
    end
  ...
  test "should update product_attachment" do
    patch product_attachment_url(@product_attachment), params: { product_attachment: { photo: @product_attachment.photo, product_id: @product_attachment.product_id } }
